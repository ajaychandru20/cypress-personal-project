describe("Test functions", () => {
    ...
    it("test file", () => {
        ...
        var requestOrder = [
            ...
            "data.fundo_function_get_intermediary_report[0].national_insurance_number",
            "data.fundo_function_get_intermediary_report[0].address_1",
            "data.fundo_function_get_intermediary_report[0].address_2",
            "data.fundo_function_get_intermediary_report[0].address_3",
            "data.fundo_function_get_intermediary_report[0].address_4",
            ...
            "data.fundo_function_get_intermediary_report[0].payment_address_line_3",
            "data.fundo_function_get_intermediary_report[0].payment_address_line_4",
