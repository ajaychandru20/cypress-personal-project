...
import { identity, infer } from './utils.js';
/* MAIN */
//TODO: Support opt-in comments
const parseBase = (input, options) => {
    /* CONSTANTS */
    const CR = 13; // \r
    const LF = 10; // \n
    ...
    /* STATE */
    let state = STATE_AFTER_DELIMITER;
...
const parseArrays = (input, options) => {
...
const parseObjects = (input, options) => {
    const INFER = !!options.infer;
    const TRANSFORM = options.transform || identity;
    const HEADERS = [];
    const ROWS = [];
